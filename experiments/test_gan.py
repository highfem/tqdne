...
def main():
    # Setting up Args
    data_file = "/home/fcomoreira/code/tqdne/datasets/japan/waveforms.npy"
    attr_file = "/home/fcomoreira/code/tqdne/datasets/japan/attributes.csv"
    batch_size = 4 
    sample_rate = 100
    gp_lambda = 10.0
    n_critic = 10
    ...
    dataset = WaveformDataset(data_file, attr_file, condv_names, cut = 0.005)
    waveform_dataloader = torch.utils.data.DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=7)
