...
srun torchrun --nproc_per_node=1 generate.py \
    ...
    --edm_checkpoint=/capstor/scratch/cscs/sdirmeie/PROJECTS/highfem/src/tqdne/experiments/workdir/outputs/Latent-EDM-32x32x4-LogSpectrogram/last.ckpt \
    --autoencoder_checkpoint=/capstor/scratch/cscs/sdirmeie/PROJECTS/highfem/src/tqdne/experiments/workdir/outputs/Autoencoder-32x32x4-LogSpectrogram/last.ckpt
